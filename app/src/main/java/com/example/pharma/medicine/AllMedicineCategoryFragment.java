...
public class AllMedicineCategoryFragment extends Fragment {
    @Override
    ...
    private void firebase(RecyclerView recyclerView) {
        ...
        CategoryRecycler adapter=new CategoryRecycler(getContext(),data,"medicine_category");
        recyclerView.setAdapter(adapter);
        DatabaseReference databaseReference= FirebaseDatabase.getInstance(new FirebaseCustomAuth()
                .loadCustomFirebase(getContext(),"tablethuts-extra")).getReference().child("Category");
